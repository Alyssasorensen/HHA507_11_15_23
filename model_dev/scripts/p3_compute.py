...
df = pd.read_csv('model_dev/data/processed/mapping_date.csv')
df = pd.read_csv('model_dev/data/processed/mapping_perp_sex.csv')
...
pickle.dump(scaler, open('model_dev/models/scaler.sav', 'wb'))  # Saving the scaler for later use
